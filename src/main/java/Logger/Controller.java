...
/**
 * Управление процессом логирования и хранение предыдущей команды
...
public final class Controller {
    ...
    /**
     * Обработка команды {@code command} на основе предыдущей забуферизованной команды (@previousCommand)
     *
